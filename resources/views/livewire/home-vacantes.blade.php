                ...
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            ...
                            <p class="text-xs font-bold text-gray-600 mb-3">{{$vacante->salario->salario}}</p>
                        ...
                        <div class="mt-5 md:mt-0">
                            <a class="bg-indigo-500 p-3 text-sm uppercase font-bold rounded-lg text-white block text-center" 
