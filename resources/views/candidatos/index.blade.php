            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="md:flex md:justify-center p-5">
                       <ul class="divid-y divide-gray-200 w-full">
                                ...
                                <li class="p-3 flex items-center">
                                    <div class="flex-1">
                                            ...
                                            <p class="text-sm font-medium text-gray-600">
                                                Dia que se postulo: <span class="font-normal"> {{$candidato->created_at->diffForHumans()}} </span></p>

                                    </div>

                                    <div>
                                        <a  class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-gray-300 tex-sm leading-5 font-medium
                            ...
                            @empty
                                <p class="p-3 tex-center text-sm text-gray-600">No hay candidatos aun</p>
                            @endforelse
                       </ul>
                    </div>
                </div>
